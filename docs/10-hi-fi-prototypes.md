...
![web page prototype with hero image, services section, and events section](./images/Homepage-hifi.png)
...
![prototype of page for single cupcake with description and allergen info](./images/singleCupcakePage-hifi.png)

This redesigned page addresses the original site's issue of lack of information on specific allergens.

### Cart Page

![cart page prototype with selected items and form for note to baker](./images/cartPage-hifi.png)
...
![order information page prototype with order status and location](./images/myOrdersFound_hifi.png)
