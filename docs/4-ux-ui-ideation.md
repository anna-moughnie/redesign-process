...
To begin drafting solutions for our [redesign project](./1-ux-ui-redesign.md), we learned about problem statements, created a feature list for our website redesign, discussed and carried out different ideation strategies, and discussed approaches to designing intuitive information architecture (IA).

## Problem Statement

To begin redesigning a website, developers must summarize the issues with the site in concrete terms with a problem statement. This is done by writing a paragraph that states clearly and concisely the aspects of the site that need improvement and the problems they cause.
...
To begin designing our solutions to the issues the website presents, we discussed three techniques to generate ideas and carried out one.
...
This concept encompasses factors such as labelling pages, navigation, and hierarchy of information. Correct application of these concepts in the context of UX/UI design allows for intuitive presentation of information and a satisfying user experience.

We applied these concepts through an activity where we were given a list of web pages (content inventory) and brainstormed intuitive ways to categorize them. This activity strengthened our understanding of constructing effective IA, which is especially vital for our website redesign, as many of the issues relate to how information is presented.
